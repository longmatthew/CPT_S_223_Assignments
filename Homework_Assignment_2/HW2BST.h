...
class HW2BST
{
	private:
		...
		bool Validate(Node *pMem);
		bool AddNode(Node* &pMem, const int &tempValue);
		bool deleteNode(Node* &pMem, const int &dataValue);
		Node *findMin(Node* &pMem);
